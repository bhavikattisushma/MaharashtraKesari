...
import listener.OnImageTouchedListener;
...
//
//				AlertMessage.showAlertWithOkCancel(
//						mContext,
//						"Alert",
//						"Do you want to save this image?",
//						true,
//						new ImageSaveAlert(mContext, DescriptionsActivity
//								.getDescImage(), DescriptionsActivity
//								.getItemId(), DescriptionsActivity
//								.getItemName()));
//
//				return true;
//			}
...
//		});
	...
	// the image at 400% zoom regardless of screen or image orientation. If in
	// the future we decode
	// the full 3 megapixel image, rather than the current 1024x768, this should
	// be changed down to
	// 200%.
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mBitmap != null && !mBitmap.isRecycled()) {
			...
			// Otherwise draw the bitmap without the paint and resubmit a new
			// request
			else {
				canvas.drawBitmap(mBitmap, mMatrix, null);
